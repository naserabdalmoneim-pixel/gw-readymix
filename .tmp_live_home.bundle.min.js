...
const mockProjects = {
  2: [
    {
      projectId: 3,
      title: "محطة بريمان للمياه",
      desc: "أعمال خرسانية لمرفق مائي حيوي",
    },
    {
      projectId: 4,
      title: "حرم مدارس الأندلس التعليمية",
      desc: "توريد خرسانة لمبانٍ تعليمية متعددة",
    },
    {
      projectId: 5,
      title: "مجمع سكني الراشدية",
      desc: "توريد خرسانة عالية الأداء لمجمع سكني متكامل",
    },
  ],
  3: [
    {
      projectId: 2,
      title: "مشروع موتيارا فيلا",
      desc: "تنفيذ متواصل لعمليات الصب مع تنسيق دقيق",
    },
    {
      projectId: 4,
      title: "حرم مدارس الأندلس التعليمية",
...
try {
  ...
  console.error("GW init error:", error);
}

function attachLanguageAndThemeControls() {
  const langBtns = document.querySelectorAll(".lang-btn");
  const themeBtns = document.querySelectorAll(".theme-btn");

  if (!langBtns.length || !themeBtns.length) return;

  langBtns.forEach((btn) => {
    btn.addEventListener("click", () => {
      const lang = String(btn.dataset.lang || "ar")
        .trim()
        .toLowerCase();
...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", attachLanguageAndThemeControls);
} else {
  attachLanguageAndThemeControls();
}
