(function () {
  ...
  const SHELL_TRANSLATIONS = {
    ar: {
      ...
      navItems: [
        { href: "/", label: "الرئيسية", activeKeys: ["home"] },
        { href: "/#about", label: "من نحن", activeKeys: [] },
        {
          href: "/#why-choose-us",
          label: "لماذا نحن",
          activeKeys: [],
        ...
        { href: "/#certificates", label: "الشهادات", activeKeys: [] },
        {
          href: "/#approvals",
          label: "أوراق الاعتماد",
          activeKeys: [],
        },
        { href: "/#contact", label: "اتصل بنا", activeKeys: [] },
      ],
      mobileItems: [
        {
          href: "/",
        ...
        },
        {
          ...
          icon: "fa-calculator",
          label: "حاسبة الخرسانة",
          activeKeys: ["calculator"],
        },
        {
          href: "/#certificates",
          icon: "fa-certificate",
      ...
      footerQuickItems: [
        ...
        { href: "/#why-choose-us", label: "لماذا نحن" },
      ...
      footerServiceItems: [
        ...
        { href: "/#approvals", label: "أوراق الاعتماد" },
    ...
    en: {
      ...
      navItems: [
        { href: "/", label: "Home", activeKeys: ["home"] },
        ...
        { href: "/#approvals", label: "Approvals", activeKeys: [] },
        { href: "/#contact", label: "Contact", activeKeys: [] },
      ],
      mobileItems: [
        {
          href: "/",
    ...
    return `
        ...
        <div class="mobile-menu" id="mobileMenu" aria-hidden="true" aria-label="${copy.mobileMenuLabel}">
            <div class="mobile-menu-header">
                <a href="${joinPath(basePath, "/")}" class="mobile-menu-logo">
                ...
                <div class="mobile-menu-tools-row">
                    <div class="language-switcher" aria-label="${copy.languageSwitcherLabel}">
                        <button class="lang-btn ${resolvedLang === "en" ? "active" : ""}" data-lang="en" type="button">
                            <img loading="lazy" decoding="async" src="${joinPath(basePath, "assets/images/flags/us.png")}" width="16" height="12" alt="English Flag"> EN
                        </button>
                        <button class="lang-btn ${resolvedLang === "ar" ? "active" : ""}" data-lang="ar" type="button">
                            <img loading="lazy" decoding="async" src="${joinPath(basePath, "assets/images/flags/sa.png")}" width="16" height="12" alt="Arabic Flag"> AR
                        </button>
                    </div>
        ...
        <nav id="navbar" aria-label="${copy.navAriaLabel}">
            <div class="container nav-container">
                <a href="${joinPath(basePath, "/")}" class="logo">
                    <img loading="lazy" src="${joinPath(basePath, "assets/images/logo.png")}" width="381" height="353" alt="Golden Western Logo" class="logo-img">
                    <div class="logo-text">
            ...
            <div class="container">
                <div class="footer-grid">
                    <div class="footer-logo">
                        <a href="${joinPath(basePath, "/")}" class="logo footer-logo-link">
                            <img loading="lazy" src="${joinPath(basePath, "assets/images/logo.png")}" width="381" height="353" alt="Golden Western Logo" class="logo-img">
                            <div class="logo-text">
