...
const SHELL_TRANSLATIONS = {
    ar: {
        ...
        footerAddress: "مبنى 9054، ابو وجاهة المرشدي، حي المرة، جدة، المملكة العربية السعودية",
        navItems: [
            { href: "index.html", label: "الرئيسية", activeKeys: ["home"] },
            { href: "index.html#about", label: "من نحن", activeKeys: [] },
            { href: "index.html#why-choose-us", label: "لماذا نحن", activeKeys: [] },
            ...
            { href: "index.html#approvals", label: "أوراق الاعتماد", activeKeys: [] },
            { href: "index.html#contact", label: "اتصل بنا", activeKeys: [] }
        ],
        mobileItems: [
            { href: "index.html", icon: "fa-home", label: "الرئيسية", activeKeys: ["home"] },
            { href: "index.html#about", icon: "fa-info-circle", label: "من نحن", activeKeys: [] },
            { href: "index.html#why-choose-us", icon: "fa-check-circle", label: "لماذا نحن", activeKeys: [] },
            { href: "index.html#products", icon: "fa-box-open", label: "المنتجات", activeKeys: [] },
            { href: "index.html#projects", icon: "fa-hard-hat", label: "المشاريع", activeKeys: [] },
            { href: "index.html#partners", icon: "fa-handshake", label: "الشركاء", activeKeys: [] },
            { href: "index.html#blog", icon: "fa-newspaper", label: "المدونة", activeKeys: ["blog"] },
            { href: "index.html#certificates", icon: "fa-certificate", label: "الشهادات", activeKeys: [] },
            { href: "index.html#approvals", icon: "fa-file-contract", label: "أوراق الاعتماد", activeKeys: [] },
            { href: "index.html#contact", icon: "fa-envelope", label: "اتصل بنا", activeKeys: [] }
        ],
        footerQuickItems: [
        ...
        footerPolicyItems: [
            ...
            { href: "refund-policy.html", label: "سياسة الاسترجاع والإلغاء" },
            { href: "tamara.html", label: "معلومات تمارا (الدفع)" }
        ]
    },
    en: {
        ...
        footerDesc: "Leading the construction industry with quality, innovation, and sustainability since 2012.",
        footerRights: "All rights reserved.",
        callLabel: "Call",
        whatsappLabel: "WhatsApp",
        mobileQuoteLabel: "Quote",
        backToTopLabel: "Back to top",
        footerAddress: "Building 9054, Abu Wajahah Al-Murshidi, Al Murrah District, Jeddah, Saudi Arabia",
        navItems: [
            ...
            { href: "index.html#certificates", label: "Certificates", activeKeys: [] },
            { href: "index.html#approvals", label: "Approvals", activeKeys: [] },
            { href: "index.html#contact", label: "Contact", activeKeys: [] }
        ],
        mobileItems: [
            { href: "index.html", icon: "fa-home", label: "Home", activeKeys: ["home"] },
            { href: "index.html#about", icon: "fa-info-circle", label: "About", activeKeys: [] },
            { href: "index.html#why-choose-us", icon: "fa-check-circle", label: "Why Us", activeKeys: [] },
            { href: "index.html#products", icon: "fa-box-open", label: "Products", activeKeys: [] },
            { href: "index.html#projects", icon: "fa-hard-hat", label: "Projects", activeKeys: [] },
            { href: "index.html#partners", icon: "fa-handshake", label: "Partners", activeKeys: [] },
            { href: "index.html#blog", icon: "fa-newspaper", label: "Blog", activeKeys: ["blog"] },
            { href: "index.html#certificates", icon: "fa-certificate", label: "Certificates", activeKeys: [] },
            { href: "index.html#approvals", icon: "fa-file-contract", label: "Approvals", activeKeys: [] },
            { href: "index.html#contact", icon: "fa-envelope", label: "Contact", activeKeys: [] }
        ],
        footerQuickItems: [
        ...
        footerPolicyItems: [
            ...
            { href: "tamara.html", label: "Tamara Payment Info" }
        ]
    }
};
                ...
                <div class="mobile-menu-footer">
                    <div class="mobile-contact-info">
                        <div class="mobile-contact-item">
                            ...
                            <span dir="ltr">+966 5 44 58 44 58</span>
                        </div>
                        <div class="mobile-contact-item">
                            <i class="fas fa-envelope"></i>
                            <span dir="ltr">info@golden-western.sa</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="footer-grid">
                    <div class="footer-logo">
                        ...
                        <div class="social-links">
                            ...
                            <a href="#" class="social-link" target="_blank" rel="noopener"><i class="fab fa-google"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="footer-links">
                        ...
                        <p class="footer-contact"><i class="fas fa-map-marker-alt"></i> ${copy.footerAddress}</p>
                        <p class="footer-contact"><i class="fas fa-phone-alt"></i> <span dir="ltr">+966 5 44 58 44 58</span></p>
                        <p class="footer-contact"><i class="fas fa-envelope"></i> <span dir="ltr">info@golden-western.sa</span></p>
                    </div>
                </div>
                <div class="copyright">
                    ...
                    <div class="policy-links">
                        ${copy.footerPolicyItems.map((item, index) => `
...
function renderSiteShell(options) {
    ...
    if (headerHost) {
        headerHost.innerHTML = createHeader({ basePath, activePage, quoteTarget, lang: resolvedLang });
    }
    ...
    if (stickyHost) {
        stickyHost.innerHTML = createStickyCta({ basePath, quoteTarget, lang: resolvedLang });
    }
